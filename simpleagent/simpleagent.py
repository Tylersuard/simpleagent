...
class Agent:
    ...
    def generate_prompt_from_instructions(self, instructions):
        ...
        The prompt should be generated in a way that is clear and concise, and should be written in a way that is easy for the AI agent to understand. Please tell the agent to explain its reasoning for each step it takes.  This is the user's instructions: """
